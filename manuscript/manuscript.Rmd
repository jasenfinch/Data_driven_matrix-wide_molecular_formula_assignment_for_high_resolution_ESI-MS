...
However, tandem MS is unsuitable for metabolome fingerprinting-based techniques due to the presence of structural isomers and isobaric compounds.
...
This is aimed at biological experiments that includes replicated samples (> 4) of experimental classes for the assignment of low accurate mass (< 1000 atomic mass units (amu)) metabolite elemental compositions of biological origin.
