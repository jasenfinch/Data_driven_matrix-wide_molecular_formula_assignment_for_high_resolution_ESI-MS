...
Using correlation networks of *m/z* feature abundances, molecular formula selection and graphical component selection, assigned molecular formulas for predicted IPs could be recovered from a subset of chemical standards spiked into an example human urine sample analysed using FIE-HRMS.
