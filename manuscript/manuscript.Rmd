...
standards_compound_outcomes %>%
  ...
  kableExtra::kable(
    ...
    caption = 'Assignments results frequencies for the 64 unique molecular formulas of the chemical standards in the standards mix and spiked into human urine.'
  ) %>%
  kableExtra::kable_styling(
    latex_options = "HOLD_position"
  )
